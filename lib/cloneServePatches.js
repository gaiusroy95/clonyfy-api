...
/** Bake Stripe/Shopify lazy-media visibility into HTML (works without site JS). */
export function bakeStaticMediaVisibilityHtml(html) {
  ...
  const bakeCss = `<style id="clonyfy-static-media-bake">.lazy-animation,.lazy-animation:not(.lazy-animation--loaded){opacity:1!important;visibility:visible!important}.payments-graphic__background-image,.payments-graphic__background-image-mobile,[class*="graphic__background-image"],[class*="-graphic__background"] picture,picture[class*="background"]{display:block!important;opacity:1!important;visibility:visible!important}.payments-graphic__background-image img,.payments-graphic__background-image-mobile img,[class*="graphic__background-image"] img{opacity:1!important;visibility:visible!important;max-width:100%}</style>`;
